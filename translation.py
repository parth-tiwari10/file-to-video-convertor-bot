...
You can convert any Telegram Document, using this bot! With custom thumbnail
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "http://t.me/filetovodbot"
...
Plan name: <a href='https://t.me/hindispot_family'>{}</a>
Expires on: {}"""
    HELP_USER = """I can do:
👉 <a href="http://t.me/filetovodbot">Convert To Streamable video any telegram file</a>
--------

🔥 How to deploy : <a href="t.me/kingt10">Click here</a>

    © Group   : @hindispot_family
    © Channel : @ben10_hindispot
                @cartoon_in
                @movies_hindispot
    © credits : @kingt10
